...
export type GetStatesError = Fetcher.ErrorWrapper<
  | {
      status: 400;
      payload: Schemas.Error;
    }
...
export const fetchGetStates = (
  ...
  apiFetch<
    ...
    undefined,
    {},
    GetStatesQueryParams,
    {}
  >({ url: "/states", method: "get", ...variables, signal });

export const useGetStates = <TData = Schemas.StateListResponse>(
  variables: GetStatesVariables,
  options?: Omit<
    reactQuery.UseQueryOptions<
      Schemas.StateListResponse,
  ...
  const { fetcherOptions, queryOptions, queryKeyFn } = useApiContext(options);
  return reactQuery.useQuery<Schemas.StateListResponse, GetStatesError, TData>({
    queryKey: queryKeyFn({
      path: "/states",
    ...
    queryFn: ({ signal }) =>
      fetchGetStates({ ...fetcherOptions, ...variables }, signal),
    ...options,
    ...queryOptions,
  });
};

export type PostStatesError = Fetcher.ErrorWrapper<
  | {
      status: 400;
      payload: Schemas.Error;
    }
...
export type PostStatesVariables = {
  body: Schemas.StateRequest;
} & ApiContext["fetcherOptions"];

export const fetchPostStates = (
  variables: PostStatesVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.StateResponse,
    PostStatesError,
    Schemas.StateRequest,
    {},
    {},
    {}
  >({ url: "/states", method: "post", ...variables, signal });

export const usePostStates = (
  options?: Omit<
    reactQuery.UseMutationOptions<
      Schemas.StateResponse,
      PostStatesError,
  ...
  return reactQuery.useMutation<
    ...
    PostStatesVariables
  >({
    mutationFn: (variables: PostStatesVariables) =>
      fetchPostStates({ ...fetcherOptions, ...variables }),
    ...options,
  });
};

export type GetStatesIdPathParams = {
  id: number;
};

export type GetStatesIdError = Fetcher.ErrorWrapper<
  | {
      status: 400;
      payload: Schemas.Error;
    }
...
export type GetStatesIdVariables = {
  pathParams: GetStatesIdPathParams;
} & ApiContext["fetcherOptions"];

export const fetchGetStatesId = (
  variables: GetStatesIdVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.StateResponse,
    ...
    {},
    {},
    GetStatesIdPathParams
  >({ url: "/states/{id}", method: "get", ...variables, signal });

export const useGetStatesId = <TData = Schemas.StateResponse>(
  variables: GetStatesIdVariables,
  options?: Omit<
    reactQuery.UseQueryOptions<Schemas.StateResponse, GetStatesIdError, TData>,
    "queryKey" | "queryFn" | "initialData"
  >,
) => {
  const { fetcherOptions, queryOptions, queryKeyFn } = useApiContext(options);
  return reactQuery.useQuery<Schemas.StateResponse, GetStatesIdError, TData>({
    queryKey: queryKeyFn({
      path: "/states/{id}",
      operationId: "getStatesId",
      variables,
    }),
    queryFn: ({ signal }) =>
      fetchGetStatesId({ ...fetcherOptions, ...variables }, signal),
    ...options,
    ...queryOptions,
  });
};

export type PutStatesIdPathParams = {
  id: number;
};

export type PutStatesIdError = Fetcher.ErrorWrapper<
  | {
      status: 400;
      payload: Schemas.Error;
    }
...
export type PutStatesIdVariables = {
  body: Schemas.StateRequest;
  pathParams: PutStatesIdPathParams;
} & ApiContext["fetcherOptions"];

export const fetchPutStatesId = (
  variables: PutStatesIdVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.StateResponse,
    ...
    {},
    {},
    PutStatesIdPathParams
  >({ url: "/states/{id}", method: "put", ...variables, signal });

export const usePutStatesId = (
  options?: Omit<
    reactQuery.UseMutationOptions<
      Schemas.StateResponse,
      PutStatesIdError,
      PutStatesIdVariables
    >,
    "mutationFn"
  >,
) => {
  ...
  return reactQuery.useMutation<
    ...
    PutStatesIdVariables
  >({
    mutationFn: (variables: PutStatesIdVariables) =>
      fetchPutStatesId({ ...fetcherOptions, ...variables }),
    ...options,
  });
};

export type DeleteStatesIdPathParams = {
  id: number;
};

export type DeleteStatesIdError = Fetcher.ErrorWrapper<
  | {
      status: 400;
      payload: Schemas.Error;
    }
...
export type DeleteStatesIdVariables = {
  pathParams: DeleteStatesIdPathParams;
} & ApiContext["fetcherOptions"];

export const fetchDeleteStatesId = (
  variables: DeleteStatesIdVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    number,
    ...
    {},
    {},
    DeleteStatesIdPathParams
  >({ url: "/states/{id}", method: "delete", ...variables, signal });

export const useDeleteStatesId = (
  options?: Omit<
    reactQuery.UseMutationOptions<
      number,
      DeleteStatesIdError,
      DeleteStatesIdVariables
    >,
    "mutationFn"
  >,
) => {
  ...
  return reactQuery.useMutation<
    ...
    DeleteStatesIdVariables
  >({
    mutationFn: (variables: DeleteStatesIdVariables) =>
      fetchDeleteStatesId({ ...fetcherOptions, ...variables }),
    ...options,
  });
};

export type PostStatesIdLocalizationsPathParams = {
  id: number;
};

export type PostStatesIdLocalizationsError = Fetcher.ErrorWrapper<
  | {
      status: 400;
      payload: Schemas.Error;
    }
...
export type PostStatesIdLocalizationsVariables = {
  body: Schemas.StateLocalizationRequest;
  pathParams: PostStatesIdLocalizationsPathParams;
} & ApiContext["fetcherOptions"];

export const fetchPostStatesIdLocalizations = (
  variables: PostStatesIdLocalizationsVariables,
  signal?: AbortSignal,
) =>
  apiFetch<
    Schemas.StateLocalizationResponse,
    PostStatesIdLocalizationsError,
    Schemas.StateLocalizationRequest,
    {},
    {},
    PostStatesIdLocalizationsPathParams
  >({
    url: "/states/{id}/localizations",
    method: "post",
    ...variables,
    signal,
  });

export const usePostStatesIdLocalizations = (
  options?: Omit<
    reactQuery.UseMutationOptions<
      Schemas.StateLocalizationResponse,
      PostStatesIdLocalizationsError,
      PostStatesIdLocalizationsVariables
    >,
    "mutationFn"
  >,
) => {
  ...
  return reactQuery.useMutation<
    ...
    PostStatesIdLocalizationsVariables
  >({
    mutationFn: (variables: PostStatesIdLocalizationsVariables) =>
      fetchPostStatesIdLocalizations({ ...fetcherOptions, ...variables }),
    ...options,
  });
};
